package de.deroq.clans.bukkit.language;
...
public class LanguageManagerImplementation implements LanguageManager {
    ...
    public ListenableFuture<Boolean> startRefreshing() {
        Bukkit.getScheduler().runTaskLater(clanSystem, () -> Bukkit.getScheduler().runTaskAsynchronously(clanSystem, this::refresh), 5*60*20);
